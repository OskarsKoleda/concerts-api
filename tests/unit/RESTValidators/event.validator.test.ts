...
describe("validateEvent should fail event validation, when", () => {
  ...
  it("title is missing", async () => {
    ...
    const { error } = validateEventPost(eventWithoutTitle as any);
  ...
  it("category is missing", async () => {
    ...
    const { error } = validateEventPost(eventWithoutCategory as any);
  ...
  it.each([EventCategory.Theatre, EventCategory.CreativeEvening])(
  ...
  it.each([EventCategory.MusicConcert, EventCategory.MusicFestival])(
    ...
    (category: EventCategory) => {
      ...
      const { error } = validateEventPost(eventWithoutBands as any);
  ...
  it("city is missing", async () => {
    ...
    const { error } = validateEventPost(eventWithoutCity as any);
  ...
  it("ticketPrice is missing", async () => {
    ...
    const { error } = validateEventPost(eventWithoutTicketPrice as any);
  ...
  it("date is missing", async () => {
    ...
    const { error } = validateEventPost(eventWithoutDate as any);
